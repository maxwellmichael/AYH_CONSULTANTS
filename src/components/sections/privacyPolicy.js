...
export default function PrivacyPolicy() {
          ...
          <strong>
            <span style="font-size: 15px;">
              <span data-custom-class="subtitle">
                Last updated
                <bdt class="question">June 17, 2022</bdt>
              </span>
            </span>
          </strong>
        </span>
        ...
        <span style="color: rgb(127, 127, 127);">
          <span style="color: rgb(89, 89, 89); font-size: 15px;">
            <span data-custom-class="body_text">
              ...
              <bdt class="question">AYH Consultants</bdt>
          ...
          <span style="font-size: 15px; color: rgb(89, 89, 89);">
            <span style="font-size: 15px; color: rgb(89, 89, 89);">
              <span data-custom-class="body_text">
                ...
                <bdt class="question">
                  <a
                    href="https://ayhconsultants.com/"
                    target="_blank"
                    data-custom-class="link"
                  >
                    https://ayhconsultants.com/
                  </a>
                </bdt>
                <span style="font-size: 15px;">
                  <span style="color: rgb(89, 89, 89);">
        ...
        <span style="font-size: 15px;">
          <span style="color: rgb(127, 127, 127);">
            <span data-custom-class="body_text">
              ...
              <bdt class="question">ayhcc47@gmail.com</bdt>
              .
            </span>
          </span>
        </span>
  ...
  return (
    <div style={styles} dangerouslySetInnerHTML={{__html: htmlText}}></div>
  )
}
